...
class Model(L.LightningModule):
    ...
    def forward(self, x, text_token_a, text_token_b, text_token_mask_a, text_token_mask_b, y=None):
        if self.cfg['model']['type'] == 'BANModel' or self.cfg['model']['type'] == 'SiamEncoderDecoder':
            ...
            return self.model((x, text_token_a, text_token_b, text_token_mask_a, text_token_mask_b))
    ...
    def training_step(self, batch, batch_idx):
        if self.cfg['model']['type'] == 'ThirdModel':
            ...
            return loss
        x, y, text_token_a, text_token_b, text_token_mask_a, text_token_mask_b, x_ori, name = batch

        yhat = self(x, text_token_a, text_token_b, text_token_mask_a, text_token_mask_b, y)
